...
```bash
docker build --target development --no-cache --tag nms-frontend-alpha:development .
```

Run:

```bash
docker run -p 3000:3000 nms-frontend-alpha:development
```
...
```bash
docker build --no-cache --tag nms-frontend-alpha .
```

Run:

```bash
docker run -p 3000:3000 nms-frontend-alpha
```
